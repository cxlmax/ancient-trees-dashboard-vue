  ...
  if (globalEvent && Array.isArray(globalEvent)) {
    ...
    try {
      ...
      const drillDownEvent = {
        type: 'mapDrillDown',
        targetId: 'N5FGUZupKVoIAYY1b8iA', // 目标元素ID
