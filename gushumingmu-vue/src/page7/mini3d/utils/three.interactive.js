...
export class InteractionManager {
    constructor(renderer, camera, domElement, options) {
        ...
        this.update = () => {
            ...
            const newClosestObject = (_a = this.interactiveObjects.find((object) => object.intersected)) !== null && _a !== void 0 ? _a : null;
        ...
        if (this.supportsPointerEvents) {
            if (this.bindEventsOnBodyElement) {
                domElement.ownerDocument.addEventListener('pointermove', this.onDocumentPointerMove);
            }
            else {
