...
// 地图
import bg from "@/assets/texture/map/mapBg2.jpg";
...
import quan4 from "@/assets/texture/map/quan/quan4.png";
...
import pointModel from "@/assets/model/coneModel.glb";
  ...
  init() {
    ...
    let assets = [
...

      {
        type: "File",
        name: "mapJson",
        path: base_url + "assets/json/gd2.json",
      },
      {
        type: "File",
        name: "mapStroke",
        path: base_url + "assets/json/gd-stroke2.json",
      },
      {
        type: "File",
        name: "hotmapData",
