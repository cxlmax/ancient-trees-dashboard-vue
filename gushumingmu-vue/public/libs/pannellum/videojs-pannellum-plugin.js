...
(function(document, videojs, pannellum) {
    ...
    const registerPlugin = videojs.registerPlugin || videojs.plugin // Use registerPlugin for Video.js >= 6

    registerPlugin('pannellum', function(config) {
        // Create Pannellum instance
        const player = this
        const container = player.el()
        const vid = container.getElementsByTagName('video')[0]
        const pnlmContainer = document.createElement('div')
