export declare const ZvChartPieIndex: import("../../../../../commons/utils/typescript").SFCWithInstall<import("vue").DefineComponent<{
    basicOption: {
        type: any;
        required: true;
    };
    ...
    customRenderData: (option: any, data: any, setOption: Function) => void;
...
export default ZvChartPieIndex;
