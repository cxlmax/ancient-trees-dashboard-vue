export declare const ZvChartLineSmoothArea: import("../../../../../commons/utils/typescript").SFCWithInstall<import("vue").DefineComponent<{
    basicOption: {
        type: any;
        required: true;
    };
...
export default ZvChartLineSmoothArea;
