export declare const ZvChartOtherGraphBasic2: import("../../commons/utils/typescript").SFCWithInstall<import("vue").DefineComponent<{
    basicOption: {
        type: any;
        required: true;
    };
...
export default ZvChartOtherGraphBasic2;
