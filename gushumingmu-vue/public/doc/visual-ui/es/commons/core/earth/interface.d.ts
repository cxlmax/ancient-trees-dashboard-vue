...
import { EarthParameter, ApertureParameter, CloudCoverParameter, StarrySkyParameter, FlightLinesItem, FlightLinesParameter } from './types';
...
export declare interface EarthInterface {
     ...
     * @returns Group 描边
     */
    createMapBorder(gis: any, borderParameter: BorderParameter): Promise<THREE.Group>;
    /**
     * 创建光晕
